...
The Stack View also displays the root URL to your published application.
...
Execute unit tests
```
    cd "KillerSodukoLambdaV2/test/KillerSodukoLambdaV2.Tests"
    dotnet test
```

Deploy application
```
    cd "KillerSodukoLambdaV2/src/KillerSodukoLambdaV2"
